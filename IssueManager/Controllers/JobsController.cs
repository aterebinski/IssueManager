...
namespace IssueManager.Controllers
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EntityId,AssignmentId,Del,Status,Checked,CreateDateTime,CreateUserId,ModifyDateTime,ModifyUserId,HistoryPreviousId,HistoryNextId")] Job job)
        {
